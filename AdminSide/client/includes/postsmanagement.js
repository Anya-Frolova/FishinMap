document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        const res = await fetch("https://fishinmap-n1oc.onrender.com/api/posts/pending");
    ...
    <img src="${post.photoSrc || 'images/emptyprofile.png'}" alt="post image">
        ...
        `;
            ...
            card.querySelector(".approve").addEventListener("click", async () => {
                const res = await fetch(`https://fishinmap-n1oc.onrender.com/api/posts/${post._id}/approve`, {
                    method: "PATCH"
                });
                if (res.ok) {
                    alert("✅ Post approved");
            ...
            card.querySelector(".decline").addEventListener("click", async () => {
                const res = await fetch(`https://fishinmap-n1oc.onrender.com/api/posts/${post._id}/decline`, {
                    method: "DELETE"
                });
                if (res.ok) {
